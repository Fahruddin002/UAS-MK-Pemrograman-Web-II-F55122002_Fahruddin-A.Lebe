          ...
          <div class="col-md-7">
            <div class="content text-center">
              <div class="border-bottom pb-5 mb-">
                <h3 class="text-dark font-weight-bold">First time here?</h3>
                <a href="/sesi/register" class="text- text-indigo-500 hover:text-indigo-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Sign up</a>
              </div>
            </div>
          </div>
        </div>
