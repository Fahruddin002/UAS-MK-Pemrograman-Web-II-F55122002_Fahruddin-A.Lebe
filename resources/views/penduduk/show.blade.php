    ...
    <div class="flex flex-row">
        ...
        <div class="max-w-lg mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
            <div class="bg-gray-900 text-center py-4">
                <h2 class="text-xl front-bold text-gray-200">Data Diri</h2>
            </div>
            <div class="p-6">
                <div class="mb-4">
                    <p class="text-gray-600 font-semibold">NIK:</p>
                    <p class="text-lg">{{$penduduk->nik}}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-600 font-semibold">Nama:</p>
                    <p class="text-lg">{{$penduduk->nama}}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-600 font-semibold">Jenis Kelamin:</p>
                    <p class="text-lg">{{$penduduk->jenis_kelamin}}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-600 font-semibold">Tempat Lahir:</p>
                    <p class="text-lg">{{$penduduk->tempat_lahir}}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-600 font-semibold">Tanggal Lahir:</p>
                    <p class="text-lg">{{$penduduk->tanggal_lahir}}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-600 font-semibold">Alamat:</p>
                    <p class="text-lg">{{$penduduk->alamat}}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-600 font-semibold">Pekerjaan:</p>
                    <p class="text-lg">{{$penduduk->pekerjaan}}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-600 font-semibold">Pendidikan Terakhir:</p>
                    <p class="text-lg">{{$penduduk->pendidikan_terakhir}}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-600 font-semibold">Agama:</p>
                    <p class="text-lg">{{$penduduk->agama}}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-600 font-semibold">Kewarganegaraan:</p>
                    <p class="text-lg">{{$penduduk->kewarganegaraan}}</p>
                </div>
                <div class="mb-4">
                    <p class="text-gray-600 font-semibold">Status Perkawinan:</p>
                    <p class="text-lg">{{$penduduk->status_perkawinan}}</p>
                </div>
                <div class="mb-4">
                    <a href="{{route('penduduk.index')}}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded inline-block mb-1">Kembali</a>
                    <a href="{{route('penduduk.edit',$penduduk->id)}}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded inline-block mb-1">Ubah</a>
                </div>
            </div>
        </div>
    </div>
