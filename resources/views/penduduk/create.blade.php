        ...
        <div class="flex flex-col w-full h-screen px-4 py-8 mt-10">
            ...
            <div class="container mx-auto p-8 bg-white rounded shadow">
                <form method="POST" action="{{route('penduduk.store')}}">
                    @csrf
                    <div class="mb-4">
                        <h2 class="text-2xl font-bold mb-2">Tambah Data Penduduk</h2>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="nik" name="nik" class="border border-gray-300 rounded-md py-2 px-3 w-full @error('nik') is-invalid @enderror" value="{{old('nik')}}">
                        @error('nik')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="pekerjaan" name="pekerjaan" class="border border-gray-300 rounded-md py-2 px-3 w-full @error('pekerjaan') is-invalid @enderror" value="{{old('pekerjaan')}}">
                        @error('pekerjaan')
                            <div class="bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-4 mt-2" role="alert">
                                <p class="font-bold">{{$message}}</p>
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="pt" name="pt" class="border border-gray-300 rounded-md py-2 px-3 w-full @error('pt') is-invalid @enderror" value="{{old('pt')}}">
                        @error('pt')
                            <div class="bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-4 mt-2" role="alert">
                                <p class="font-bold">{{$message}}</p>
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="agama" name="agama" class="border border-gray-300 rounded-md py-2 px-3 w-full @error('agama') is-invalid @enderror" value="{{old('agama')}}">
                        @error('agama')
                            <div class="bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-4 mt-2" role="alert">
                                <p class="font-bold">{{$message}}</p>
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="warga" name="warga" class="border border-gray-300 rounded-md py-2 px-3 w-full @error('warga') is-invalid @enderror" value="{{old('warga')}}">
                        @error('warga')
                            <div class="bg-orange-100 border-l-4 border-orange-500 text-orange-700 p-4 mt-2" role="alert">
                                <p class="font-bold">{{$message}}</p>
                            </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex items-center mb-2">
                            <input type="radio" id="sp" name="sp" value="belum-kawin" class="form-radio h-5 w-5 text-blue-600 @error('sp') is-invalid @enderror" {{old('sp') === 'belum-kawin' ? 'checked' :''}}>
                            <label for="not-married" class="ml-2 text-gray-700">Belum Kawin</label>    
                        </div>
                        <div class="flex items-center mb-2">
                            <input type="radio" id="sp" name="sp" value="kawin" class="form-radio h-5 w-5 text-blue-600 @error('sp') is-invalid @enderror" {{old('sp') === 'kawin' ? 'checked' :''}}>
                            <label for="married" class="ml-2 text-gray-700">Kawin</label>    
                        </div>
                        <div class="flex items-center mb-2">
                            <input type="radio" id="sp" name="sp" value="cerai-hidup" class="form-radio h-5 w-5 text-blue-600 @error('sp') is-invalid @enderror" {{old('sp') === 'cerai-hidup' ? 'checked' :''}}>
                            <label for="divorced" class="ml-2 text-gray-700">Cerai Hidup</label>    
                        </div>
                        <div class="flex items-center mb-2">
                            <input type="radio" id="sp" name="sp" value="cerai-mati" class="form-radio h-5 w-5 text-blue-600 @error('sp') is-invalid @enderror" {{old('sp') === 'cerai-mati' ? 'checked' :''}}>
                    ...
                    <div>
                        <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" name="tambah">Tambah</button>
                    </div>
                </form>
            </div>
        </div>
